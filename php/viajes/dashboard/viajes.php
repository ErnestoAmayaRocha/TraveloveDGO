  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider d-none d-md-block">
       ...
       <!-- Nav Item - Tables -->
       <li class="nav-item ">
        <a class="nav-link" href="../../emleados/dashboard/empleados.php">
          <i class="fas fa-fw fa-table"></i>
...
$query=mysqli_query($mysqli, "SELECT * FROM empleados WHERE puesto= 'Staff'");
$query1=mysqli_query($mysqli, "SELECT * FROM empleados WHERE puesto= 'Staff'");
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                            <td><?php echo $dat['id_destino'] ?></td>
                                <td><?php echo $dat['destino'] ?></td>
                                <td><?php echo $dat['descripcion'] ?></td>
                                <td><?php echo $dat['precio'] ?></td>
                                <td><?php echo $dat['encargado1'] ?></td>
                                <td><?php echo $dat['encargado2'] ?></td>
        ...
        <form id="formPersonas">    
            <div class="modal-body">
                ...
                <?php                            
                            ...
                            ?>
                <option value="<?php echo $datos['id_empleado']?>"><?php echo $datos['id_user']?>  <?php echo $datos['nombre']?> </option>
                ...
                <?php                            
                            ...
                            ?>
                <option value="<?php echo $datos['id_viaje']?>"><?php echo $datos['id_viaje']?>  <?php echo $datos['destino']?> </option>
                ...
                <div class="form-group">
                <label for="nombre" class="col-form-label">Costo:</label>
