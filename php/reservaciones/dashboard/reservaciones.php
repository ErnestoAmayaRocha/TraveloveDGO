...
<div class="container">
    <h1>Administrador de Reservaciones</h1>
...
$query1=mysqli_query($mysqli, "SELECT * FROM viajes");
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                            <td><?php echo $dat['id_reserv'] ?></td>
                                <td><?php echo $dat['id_usuario'] ?></td>
                                <td><?php echo $dat['destino1'] ?></td>
                                <td><?php echo $dat['costo1'] ?></td>
        ...
        <form id="formPersonas">    
            <div class="modal-body">
                ...
                <?php                            
                            ...
                            ?>
                <option value="<?php echo $datos['id_user']?>"><?php echo $datos['id_user']?>  <?php echo $datos['usuario']?> </option>
