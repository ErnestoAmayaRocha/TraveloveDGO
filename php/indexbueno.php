      ...
      <div class="row">
        ...
        <div class="col-md-6 pl-0" id="about">
          <div class="content">
            ...
            <h4>Misión</h4>
            <hr/>
            <p>Crear momentos de felicidad y emoción a través de la experiencia de viajar, volver inmortales
              los recuerdos de cada viaje en cada uno de nuestros clientes.</p>
            <h4>Visión</h4>
            <hr/>
            <p>Liderar en el mercado estatal a través del reconocimiento de nuestros clientes por rindar 
              las mejores experiencias al cliente,con vajes llenos de magia y diversión.</p>
      ...
      <div class="container" id="team">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.6s">
            ...
            <p>Máxima autoridad en la gestión y dirección administrativa de Travelove Dgo.</p>
          ...
          <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.9s">
            ...
            <h3>Jesús Rueda</h3>
            <p>Garantiza la eficiencia, productividad y desempeño general de Travelove Dgo.</p>
        ...
        <div class="owl-carousel owl-carousel3 owl-theme">
          <div>
            <div class="card"> <img class="card-img" src="../cssindex/assets/img/mexi13.jpg" alt="">
              <div class="card-img-overlay">
                <div class="bottom-text">
                  <h5 class="card-title">Mexiquillo</h5>
                  <a href="mexiquillo.html" target="_blank" >Leer más <img src="../assets/img/double-right.svg" alt=""></a> 
                </div>
              </div>
            </div>
          </div>
          <div>
            <div class="card"> <img class="card-img" src="../cssindex/assets/img/maza11.jpg"  alt="">
              <div class="card-img-overlay">
                <div class="bottom-text">
                  <h5 class="card-title">Mazatlán</h5>
                  <a href="mazatlan.html" target="_blank" >Leer más <img src="../assets/img/double-right.svg" alt=""></a> 
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card"> <img class="card-img" src="../cssindex/assets/img/cubi3.jpg" alt="">
              <div class="card-img-overlay">
                <div class="bottom-text">
                  ...
                  <a href="cubilete.html" target="_blank" >Leer más <img src="../assets/img/double-right.svg" alt=""></a> 
                </div>
              </div>
            </div>
          </div>
