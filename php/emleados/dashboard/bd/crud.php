...
switch($opcion){
    case 1: //alta
        $consulta = "INSERT INTO empleados (nombre, apellido_p, apellido_m, correo, direccion, telefono, puesto) VALUES('$nombre', '$apellido_p', '$apellido_m','$correo','$direccion','$telefono','$puesto') ";			
