...
<head>
  ...
  <meta name="author" content="">
    <link rel="shorcut icon" type="image/x-icon" href="logotra.png" >
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider d-none d-md-block">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="dudas.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Dudas</span></a>
      </li>
<hr class="sidebar-divider d-none d-md-block">
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                            <td><?php echo $dat['id_duda'] ?></td>
                                <td><?php echo $dat['nombreyapellidos'] ?></td>
                             
                                <td><?php echo $dat['correo_electronico'] ?></td>   
                                <td><?php echo $dat['tumensaje'] ?></td> 
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPersonas">    
            <div class="modal-body">
                ...
                <div class="form-group">
                <label for="pais" class="col-form-label">Direccion de correo:</label>
                <input type="text" class="form-control" id="apellido_p" require>
                </div>                

                <div class="form-group">
                <label for="edad" class="col-form-label">Asunto:</label>
                <input type="text" class="form-control" id="apellido_m" require>
                </div>  

                <div class="form-group">
                <label for="nombre" class="col-form-label">Mensaje:</label>
