$(document).ready(function(){
    tablaPersonas = $("#tablaPersonas").DataTable({
       "columnDefs":[{
        "targets": -1,
        "data":null,
        "defaultContent": "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btnEditar'>Responder</button><button class='btn btn-danger btnBorrar'>Borrar</button></div></div>"  
       }],
...
$(document).on("click", ".btnEditar", function(){
    ...
    $(".modal-header").css("color", "white");
    $(".modal-title").text("Responder mensaje");            
    $("#modalCRUD").modal("show");  
